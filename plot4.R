...
############################################################
# plot4.png                                                #
# split plot region into four plots                        #
# plot each part                                           #
############################################################
...
# plot data
plot(subset.data$timestamp,subset.data$Global_active_power, type="l", xlab="", ylab="Global Active Power")




# plot second plot: top-right

# prepare y-dimension which is Voltage
subset.data$Voltage <- as.numeric(subset.data$Voltage)

# plot data
plot(subset.data$timestamp,subset.data$Voltage, type="l", xlab="datetime", ylab="Voltage")




#plot third plot: bottom left
...
#plot fourth plot: bottom right
# prepare y-dimension which is Global reactive power
subset.data$Global_reactive_power <- as.numeric(subset.data$Global_reactive_power)

# plot data
plot(subset.data$timestamp,subset.data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
